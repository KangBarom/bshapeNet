...
_POLY_TYPE = list
# Type used for storing masks in RLE format cfg.BSHAPE.PIXELS
_RLE_TYPE = dict
...
def polys_to_mask(polygons, height, width):
    ...
    countors, _ = cv2.findContours(thr, cv2.RETR_TREE, cv2.CHAIN_APPROX_SIMPLE)
    ...
    if pixels ==3:
        ...
        mask = np.where(mask == 7, 1, np.where(mask == 6, 0.95, np.where(mask == 5, 0.85, np.where(mask == 4, 0.70,
                                                                                                             0))))
    elif pixels ==5:
        ...
        mask = np.where(mask == 15, 1, np.where(mask == 14, 0.95, np.where(mask == 13, 0.90, np.where(mask == 12, 0.85,
                                                                                                     np.where(mask == 11,
                                                                                                              0.80,
                                                                                                              np.where(
                                                                                                                  mask == 10,
        ...
        mask = np.where(mask == 21, 1, np.where(mask == 20, 0.95, np.where(mask == 19, 0.90, np.where(mask == 18, 0.85,
                                                                                                     np.where(mask == 17,
                                                                                                              0.80,
                                                                                                              np.where(
                                                                                                                  mask == 16,
