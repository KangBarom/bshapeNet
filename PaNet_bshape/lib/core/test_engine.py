...
def run_inference(
    ...
    def result_getter():
        if is_parent:
            ...
            print('range(len(cfg.TEST.DATASETS): ',range(len(cfg.TEST.DATASETS)))
...
def test_net_on_dataset(
    ...
    test_timer = Timer()
    test_timer.tic()
    print('test_net_one_dataset()')
    if multi_gpu:
        print('multi_gpu check: True')
